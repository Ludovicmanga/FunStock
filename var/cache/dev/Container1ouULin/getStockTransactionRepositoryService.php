 ...
 */
class getStockTransactionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StockTransactionRepository' shared autowired service.
     *
     * @return \App\Repository\StockTransactionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StockTransactionRepository.php';

        return $container->privates['App\\Repository\\StockTransactionRepository'] = new \App\Repository\StockTransactionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
